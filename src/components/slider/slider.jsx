...
export default function Slider2() {
  ...
  return (
    <Box sx={{display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: 0, paddingBottom:0, marginTop: -5}}>
      <div>
        <Typography sx={{display: 'flex', justifyContent: 'center', fontFamily: 'ZonaBlack, sans-serif', fontSize: '30px', paddingBottom: '22px', color: '#c784ee'}} id="Slider2" gutterBottom>
          distance in miles
        </Typography>
